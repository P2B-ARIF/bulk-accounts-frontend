		...
		<div>
			<div className='flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white'>
				<div className='text-center'>
					...
					<button
						onClick={() => navigate("/")}
						className='bg-red-500 text-white rounded-lg py-1.5 px-5 shadow border hover:border-red-500 hover:bg-red-100 hover:text-red-500 transition-all duration-150 ease-linear mt-5'
					>
						Go Back
					</button>
				</div>
